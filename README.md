...
| Лучшая модель                                                                                                                                                                                                                          | Лучшая CV | Время обучения (сек.) | Время предсказания (сек.) |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ----------------- | ---------------- |
| RandomForestClassifier(class_weight='balanced', max_depth=48, min_samples_leaf=40, n_estimators=160, n_jobs=-1, random_state=20226)                                                                                                 | 0.8069  | 0.12              | 0.02             |
| LGBMClassifier(class_weight='balanced', learning_rate=0.11115497459571116, max_depth=48, n_estimators=256, n_jobs=-1, num_leaves=21, random_state=20226, reg_alpha=0.16465834707598878, reg_lambda=0.03689323680916021, verbose=-1) | 0.8830  | 0.83              | 0.01             |
| AdaBoostClassifier(learning_rate=0.46885372523216223, n_estimators=208, random_state=20226)                                                                                                                                         | 0.8000  | 0.24              | 0.01             |
| RidgeClassifier(alpha=89.79055482307352, class_weight='balanced', max_iter=128, random_state=20226)                                                                                                                                 | 0.7100  | 0.01              | 0.00             |
| PassiveAggressiveClassifier(C=0.011745605397540439, class_weight='balanced', max_iter=80, random_state=20226)                                                                                                                       | 0.7042  | 0.01              | 0.00             |
| SVC(C=5.116696944302569, class_weight='balanced', gamma='auto', random_state=20226)                                                                                                                                                 | 0.7771  | 0.24              | 0.06             |
